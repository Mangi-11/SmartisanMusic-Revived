...
- **新增个性化设置**：加入艺术家分隔符、底部导航栏显示项、可切换应用图标和简易音效；除原版图标外，还保留了 realme UI 7.0 音乐的黄色黑胶图标，并按 Android adaptive icon 规范接入彩色与单色图层。音效提供几种预设及自定义均衡曲线。
